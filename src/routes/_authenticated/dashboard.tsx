...
import {
  Truck, Users, Route as RouteIcon, AlertTriangle, Fuel, Wrench, TrendingUp, ChevronRight,
} from "lucide-react";
            ...
            {fuelSeries ? (
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={fuelSeries} margin={{ top: 5, right: 5, bottom: 0, left: 0 }}>
                  ...
                  <XAxis dataKey="date" tick={{ fontSize: 10 }} interval={Math.ceil((fuelSeries.length || 1) / 6)} axisLine={false} tickLine={false} />
